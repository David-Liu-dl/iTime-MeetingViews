...
//        swipeLayout.setDragEdge(SwipeLayout.DragEdge.Bottom); // Set in XML
        ...
        sample1.addDrag(SwipeLayout.DragEdge.Right, sample1.findViewById(R.id.menu));
        ...
        sample1.findViewById(R.id.muteBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        sample1.findViewById(R.id.archive_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        sample1.findViewById(R.id.pinBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
